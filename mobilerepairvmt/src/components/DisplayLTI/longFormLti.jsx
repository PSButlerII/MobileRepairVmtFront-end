      ...
      <React.Fragment>
        <div className="container ">
          <div >
            <div className="block">
              <div>
                <form onSubmit={handleSubmit} className="col-md-3 center">
                  ...
                  <div className="form-floating">
                    ...
                    />
                    <label for="floatingcoolingSystemd">coolingSystem</label>
                  </div>
                  <div className="form-floating">
                    <input
                      name="battery"
                  ...
                  <div className="form-floating">
                    ...
                    />
                    <label for="floatinghydraulicSystem">hydraulicSystem</label>
                  </div>
                  <div className="form-floating">
                    <input
                      name="frame"
                  ...
                  <div className="form-floating">
                    ...
                    />
                    <label for="floatingshockAbsorbers">shockAbsorbers</label>
                  </div>
                  <div className="form-floating">
                    <input
                      name="springs"
